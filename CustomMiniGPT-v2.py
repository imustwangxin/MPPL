...
def default_crop_person(chatbot, gr_img):
    ...
    if len(entities) == 0:
        ...
        bottom = 200
        bugflag = True
        bugNum = '003' # raise ValueError(f"No target detected.")
...
if __name__ == '__main__':
    ...
    # wangxin-24407:  0     : 15000
    # wangxin1-54028: 15000 : 30000  第一次中断于2186. 开始15000+2186:30000
    # wangxin2-59072: 30000 : 45000
    # wangxin3-45171: 45000 : 56880  第一次中断于2895. 开始45000+2895:. 第二次中断于594. 开始45000+2895+594:. 同样的问题，跳过：45000+2895+595. 第四次中断于3600. 开始45000+2895+595+3601
    for filename in tqdm(videosList[45000+2895+595+3601:]):
